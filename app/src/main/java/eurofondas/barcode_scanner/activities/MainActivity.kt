package eurofondas.barcode_scanner.activities
...
import eurofondas.barcode_scanner.databinding.ActivityMainBinding
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val imageAnalyzer = ImageAnalysis.Builder()
                ...
                .build()
                .also {
                    it.setAnalyzer(cameraExecutor, ImageAnalyzer(applicationContext))
                }
